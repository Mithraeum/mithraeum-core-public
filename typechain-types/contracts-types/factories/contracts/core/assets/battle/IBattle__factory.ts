...
import type {
  IBattle,
  IBattleInterface,
} from "../../../../../contracts/core/assets/battle/IBattle";
...
const _abi = [
  ...
  },
  {
    inputs: [
      {
        internalType: "uint256[]",
        name: "stage1SideACasualties",
        type: "uint256[]",
      },
      {
        internalType: "uint256[]",
        name: "stage1SideBCasualties",
        type: "uint256[]",
      },
    ],
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: "uint256",
        name: "sideAUnitsAmount",
        type: "uint256",
      },
      {
        internalType: "uint256",
        name: "sideBUnitsAmount",
        type: "uint256",
      },
    ],
...
export class IBattle__factory {
  ...
  static createInterface(): IBattleInterface {
    return new Interface(_abi) as IBattleInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IBattle {
    return new Contract(address, _abi, runner) as unknown as IBattle;
  }
}
