...
export interface WorkersUnitsPoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "assetGroupId"
      | "assetTypeId"
...
export interface WorkersUnitsPool extends BaseContract {
  connect(runner?: ContractRunner | null): WorkersUnitsPool;
  waitForDeployment(): Promise<this>;

  interface: WorkersUnitsPoolInterface;
