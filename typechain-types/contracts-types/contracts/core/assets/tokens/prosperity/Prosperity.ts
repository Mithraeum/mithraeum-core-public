...
export interface ProsperityInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface Prosperity extends BaseContract {
  connect(runner?: ContractRunner | null): Prosperity;
  ...
  prosperitySpent: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
