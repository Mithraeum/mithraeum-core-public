...
export interface IUnitsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface IUnits extends BaseContract {
  connect(runner?: ContractRunner | null): IUnits;
  waitForDeployment(): Promise<this>;

  interface: IUnitsInterface;
