...
export interface IResourceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface IResource extends BaseContract {
  connect(runner?: ContractRunner | null): IResource;
  ...
  resourceTypeId: TypedContractMethod<[], [string], "nonpayable">;
  ...
  tokenName: TypedContractMethod<[], [string], "nonpayable">;

  tokenSymbol: TypedContractMethod<[], [string], "nonpayable">;
  ...
  ): TypedContractMethod<[tokensOwner: AddressLike], [bigint], "view">;
  getFunction(
