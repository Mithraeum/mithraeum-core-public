...
export interface WorldAssetStorageAccessorWithoutPush0Interface
  extends Interface {
  getFunction(
...
export interface WorldAssetStorageAccessorWithoutPush0 extends BaseContract {
  connect(
    runner?: ContractRunner | null
  ): WorldAssetStorageAccessorWithoutPush0;
  waitForDeployment(): Promise<this>;

  interface: WorldAssetStorageAccessorWithoutPush0Interface;
