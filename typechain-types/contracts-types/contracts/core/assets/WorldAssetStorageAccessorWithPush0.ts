...
export interface WorldAssetStorageAccessorWithPush0Interface extends Interface {
  getFunction(
...
export interface WorldAssetStorageAccessorWithPush0 extends BaseContract {
  connect(runner?: ContractRunner | null): WorldAssetStorageAccessorWithPush0;
  waitForDeployment(): Promise<this>;

  interface: WorldAssetStorageAccessorWithPush0Interface;
