...
export interface World extends BaseContract {
  ...
  addWorldAsset: TypedContractMethod<
    [eraNumber: BigNumberish, worldAsset: AddressLike, assetType: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  eras: TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  ...
  implementations: TypedContractMethod<[arg0: BytesLike], [string], "view">;
  ...
  mintWorkers: TypedContractMethod<
    [eraNumber: BigNumberish, _to: AddressLike, _value: BigNumberish],
    [void],
    "nonpayable"
  >;
