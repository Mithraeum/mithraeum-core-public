...
export interface IDistributionsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "balanceOfBatch"
...
export interface IDistributions extends BaseContract {
  connect(runner?: ContractRunner | null): IDistributions;
  waitForDeployment(): Promise<this>;

  interface: IDistributionsInterface;
