...
export interface RegionOwnershipTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface RegionOwnershipToken extends BaseContract {
  connect(runner?: ContractRunner | null): RegionOwnershipToken;
  waitForDeployment(): Promise<this>;

  interface: RegionOwnershipTokenInterface;
